...
tipos_contagem = ["CONTÍNUA", "C", "PARCIAL", "P"]
...
tipo_contagem = ''
while tipo_contagem not in tipos_contagem:
    tipo_contagem = input('Defina o tipo de contagem [CONTÍNUA/C ou PARCIAL/P]: ').upper()

if tipo_contagem in tipos_contagem[:2]:
    ...
    cartas_dupla01 = int(input('Informe o Valor de Pontos de Cartas obtidos na Rodada pela Dupla 01: '))
    ...
    cartas_dupla02 = int(input('Informe o Valor de Pontos de Cartas obtidos na Rodada pela Dupla 02: '))
    # Realiza a soma de pontos de mesa e cartas da Dupla 01 na rodada atual
...
if total_dupla01 > total_vulneravel:
    ...
    if total_dupla02 > total_vulneravel:
        print ('As Duplas estão vulneráveis!!!')
    else:
        print ('A Dupla 01 está vulnerável!!!')
#    else:
#        if total_dupla02 > total_vulneravel:
...
if total_dupla01 > total_partida:
    ...
    if total_dupla01 > total_dupla02:
        print ('A Dupla 01 venceu a partida!!!')
    else:
        if total_dupla02 > total_partida:
